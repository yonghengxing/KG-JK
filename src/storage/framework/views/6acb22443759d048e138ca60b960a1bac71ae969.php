        ...
        <div class="row">
            <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                <div class="widget am-cf">
                    ...
                    <form class="am-form am-form-horizontal " action="<?php echo e(asset('relationType/new')); ?>" method="post" onsubmit="return checkForm()" >
                        <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>" />
                        <div class="am-form-group">
                            <label for="rname" class="am-u-sm-3 am-form-label">关系类型</label>
                            <div class="am-u-sm-6 am-u-end">
                                <input type="text" id="rname" name="rname" placeholder="输入关系类型名称">
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-6 am-u-end">
                                <input type="text" id="rlabel" name="rlabel" placeholder="输入关系标识，仅限英文">
                            </div>
                        </div>
