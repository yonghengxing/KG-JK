                 ...
                 <form horizontal="true"  enctype="multipart/form-data" class="am-form am-form-horizontal " action="<?php echo e(asset('/addDB_do')); ?>" method="post">
                 	...
                 	<div class="am-form-group">
                        ...
                        <div class="am-u-sm-6 am-u-end">
                        	<input type="text" class="tpl-form-input" id="name"  name="name" placeholder="请输入名称" value="<?php echo e($name); ?>">                             	
                        </div>
                    </div>
             	   ...
             	   <div class="am-form-group">
                        ...
                        <div class="am-u-sm-6 am-u-end">
                        	<input type="text" class="tpl-form-input" id="IP"  name="IP" placeholder="请输入IP" value=" <?php echo e($IP); ?>">                             	
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-6 am-u-end">
                        	<input type="text" class="tpl-form-input" id="port"  name="port" placeholder="请输入端口" value=" <?php echo e($port); ?>">                             	
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-6 am-u-end">
                        	<input type="text" class="tpl-form-input" id="dbname"  name="dbname" placeholder="请输入数据库名称" value=" <?php echo e($dbname); ?>">                             	
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-6 am-u-end">
                        	<input type="text" class="tpl-form-input" id="username"  name="username" placeholder="请输入用户名" value=" <?php echo e($username); ?>">                             	
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-6 am-u-end">
                        	<input type="text" class="tpl-form-input" id="password"  name="password" placeholder="无密码" value="<?php echo e($password); ?>">                             	
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-6 am-u-end">
                                <input type="text" class="tpl-form-input" id="type"  name="type" placeholder="无" value=" <?php echo e($type); ?>">   
                        </div>
                    </div>
