  ...
  <div class="row">
       <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
            <div class="widget am-cf">
                 ...
                 <form class="am-form tpl-form-border-form  tpl-form-border-br am-form-horizontal " action="{{asset('schema/new')}}" method="post" onsubmit="return checkForm()">
					...
					<script type="text/javascript">
						function checkForm(){
							...
							var Attr1Text = document.getElementById("Attr1").value;
							if ( Attr1Text == "" || Attr1Text == null ){
									alert("请输入属性标识！");
									return false;
							}
