 ...
 <div class="row-content am-cf" >
    <div class="widget am-cf">
        ...
        <div class="widget-body" style="overflow-y:auto;overflow-x:auto;">
    		<iframe id="myframe" style="width:100%;" allowfullscreen mozallowfullscreen webkitallowfullscreen src="<?php echo e(config("properties")['graphIP']); ?>/#/schema-designer" scrolling="no" onload="changeFrame()" frameborder="0">
    		</iframe>
		</div>
	</div>
</div>
