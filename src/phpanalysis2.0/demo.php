...
<form id="form1" name="form1" method="post" action="?ac=done" style="margin:0px;padding:0px;line-height:24px;">
    ...
    <br/>
    <input type='checkbox' name='do_fork' value='1' hidden <?php echo ($do_fork ? "checked='1'" : ''); ?>/>
    <input type='checkbox' name='do_unit' value='1' hidden <?php echo ($do_unit ? "checked='1'" : ''); ?>/>
    <input type='checkbox' name='do_multi' value='1' hidden <?php echo ($do_multi ? "checked='1'" : ''); ?>/>
    <input type='checkbox' name='do_prop' value='1' hidden <?php echo ($do_prop ? "checked='1'" : ''); ?>/>
    <input type='checkbox' name='pri_dict' value='1' hidden <?php echo ($pri_dict ? "checked='1'" : ''); ?>/>
    <br/>
    <input type="submit" name="Submit" value="提交进行分词" />
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <input type="reset" name="Submit2" value="重设表单数据" hidden />
</form>
<br />
