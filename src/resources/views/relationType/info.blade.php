  ...
  <div class="row">
       <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
            <div class="widget am-cf">
                 ...
                 <form class="am-form am-form-horizontal " action="{{asset('relationType/info')}}/{{$relationType->tid}}" method="post" >
                 	<input type="hidden" name="_token" value="{{ csrf_token() }}" />
                 	<div class="am-form-group">
                      <label for="ontoDisplayName" class="am-u-sm-3 am-form-label">类型名称 / Name</label>
                      <div class="am-u-sm-9">
                        <input type="text" id="ontoDisplayName"  name="relationType" value="{{ $relationType->relationlabel }}">
                    ...
                    <div class="am-form-group">
                      ...
                      <div class="am-u-sm-9">
                        <input type="text" id="ontoDisplayName"  name="mytext" value="{{ $relationType->icon }}">
                        <small>请选择图标</small>
                      </div>
                    </div>  
