...
<script type="text/javascript">
	...
	function addUser()
	{
		...
		var str = '<div class="am-form-group" index="'+
		 ...
		 userIndex + '">@foreach($users as $user)<option value="{{ $user->id }}">{{ $user->name }}</option>@endforeach</select></div></div>';
		$("#showUser").append(str);
        ...
        <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
            <div class="widget am-cf">
				...
				<div class="am-cf">
					...
					<form class="am-form am-form-horizontal "action="{{  asset('/datasource/useradd')}}/{{$dbname}}/{{$dbsname}}" method="post" enctype="multipart/form-data">
