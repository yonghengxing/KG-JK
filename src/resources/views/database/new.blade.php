  ...
  <div class="row">
       <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
            <div class="widget am-cf">
                 ...
                 <form horizontal="true"  enctype="multipart/form-data" class="am-form am-form-horizontal tpl-form-border-form  tpl-form-border-br" action="{{ asset('/addDB_do')}}" method="post" onsubmit="return checkForm()">
