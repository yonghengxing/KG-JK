                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9 ">
                                <select data-am-selected="{searchBox: 1}"  id="stype" name="stype">
                                    ...
                                    <option value="{{ $entity->sid }}">{{ $entity->stype }}</option>
                                </select>
                            </div>
                        </div>
                        <script type="text/javascript">
                        ...
                        <div id="showArri">
                            @foreach($properties as $key=>$value)
                                <div class="am-form-group" index="1" id="Attr1">
                                    ...
                                    <div class="am-u-sm-4">
                                        <input type="text" id="attribute-name2" name="labels[]" value="{{$key}}">
                                    </div>
                                    <label for="attribute-value1" class="am-u-sm-1 am-form-label" >属性值</label>
                                    <div class="am-u-sm-4 am-u-end">
                                        <input type="text" id="attribute-value1"  name="properties[]" value="{{$value}}">
                                    </div>
